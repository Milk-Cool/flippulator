...
void cli_process_input(Cli* cli) {
    ...
    if(in_chr == CliSymbolAsciiTab) {
        ...
        // We are not getting this symbol in the terminal,
        // so we handle the motd printing and the prompt
        // printing in the cli thread instead.
    ...
    } else if(in_chr == CliSymbolAsciiLF) { // not CR
